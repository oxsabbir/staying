        ...
        <section className="bg-primary pb-14 pt-12 text-white">
          <div className="container">
            ...
            <form
              ...
              className="mt-8 rounded-md border-2   border-accent bg-accent p-[2px] text-text shadow-sm"
            >
              <div className="grid gap-[2px] md:grid-cols-2 gap-x-1 items-center xl:grid-cols-[2.5fr_1fr_0.8fr_1fr_0.8fr_auto]">
                <div className="flex min-h-[52px] items-center rounded-sm bg-white px-3 py-2">
                  <AutocompleteInput
