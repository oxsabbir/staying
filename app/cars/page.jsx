...
export default function CarRentalPage() {
  const [form, setForm] = useState({
    pickupLocation: 'Pabna, Pabna, Bangladesh',
    pickupDate: '',
    pickupTime: '10:00',
    dropoffDate: '',
    dropoffTime: '10:00',
  ...
  const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '8801000000000';
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] text-text">
      ...
      <main>
        <section className="bg-primary pb-14 pt-12 text-white">
          <div className="container">
            ...
            <form
              ...
              className="mt-8 rounded-md border-4 border-accent bg-white p-2 text-text shadow-sm"
            >
              <div className="grid gap-2 lg:grid-cols-[2.2fr_1.2fr_1fr_1.2fr_1fr_auto]">
                <div className="rounded-sm border border-border px-3 py-2">
                  <AutocompleteInput
                    placeholder="Pick-up location"
                    value={form.pickupLocation}
                    onChange={(value) => handleChange('pickupLocation', value)}
                    onSelect={(value) => handleChange('pickupLocation', value)}
                ...
                <div className="rounded-sm border border-border px-3 py-2">
                  <DateRangeDropdown
                    ...
                    onChange={({ startDate, endDate }) => {
                      ...
                      handleChange('dropoffDate', endDate);
                    }}
                    placeholder="Pick-up date - Drop-off date"
                  />
                </div>

                <label className="flex items-center gap-2 rounded-sm border border-border px-3 py-2">
                ...
                <div className="flex items-center rounded-sm border border-border px-3 py-2 text-sm text-muted">
                  {form.dropoffDate || 'Selected from calendar'}
                </div>
                ...
                <button
                  type="submit"
                  className="rounded-sm bg-link px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#005dc1]"
                >
                  Book now
                </button>
              </div>
          ...
          <div className="container grid gap-8 md:grid-cols-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted">Customer support in over 30 languages</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Image
              ...
              <div>
                ...
                <p className="text-sm text-muted">Up to 48 hours before pick-up for most bookings</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Image
              ...
              <div>
                ...
                <p className="text-sm text-muted">By real, verified customers</p>
              </div>
            </div>
          </div>
        </section>
